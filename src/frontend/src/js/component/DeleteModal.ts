...
export default class DeleteModal {
  ...
  constructor(message: string = '削除が完了しました') {
  ...
  private createModals(): void {
    ...
    this.confirmModal.id = 'deleteConfirmModal';
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="confirm-message">データを削除します。よろしいですか？</p>
            <div class="delete-error-message alert alert-danger d-none" role="alert">
    ...
    this.successModal.id = 'deleteSuccessModal';
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-body text-center py-4">
            ...
            <h5 class="delete-success-message mb-3">削除が完了しました</h5>
    ...
    // 要素の参照を保存
    this.messageElement = this.successModal.querySelector('.delete-success-message');
    this.iconElement = this.successModal.querySelector('.delete-success-icon');
    this.errorMessageElement = this.confirmModal.querySelector('.delete-error-message');
    ...
    this.confirmYesButton?.addEventListener('click', async () => {
      if (this.onConfirmCallback) {
        ...
        if (this.confirmYesButton) {
          this.confirmYesButton.innerHTML = '<i class="bi bi-arrow-repeat" style="animation: spin 1s linear infinite;"></i> 削除中...';
        }
  ...
  public showConfirm(onConfirm: () => Promise<string>): void {
    if (!this.isInitialized || !this.confirmModal || !this.confirmBackdrop) {
      console.error('削除モーダルが初期化されていません');
      return;
    }
  ...
  private showError(): void {
    if (this.errorMessageElement) {
      // デフォルトのエラーメッセージに戻す
      this.errorMessageElement.innerHTML = '<i class="bi bi-exclamation-triangle-fill"></i> 削除に失敗しました。';
  ...
  public showCustomError(message: string, onClose?: () => void): void {
    ...
    if (btnDelete) {
      btnDelete.innerHTML = '<i class="bi bi-trash"></i> 削除';
